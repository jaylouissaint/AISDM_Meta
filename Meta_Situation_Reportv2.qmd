...
```{r fig-pop-bing, fig.cap = "Based on the Bing tiles, there are only a few counties with strong population density changes.", eval = F}
make_percent_change_map(
  file_name = "tk_facebook_pop_aggregated_bing.csv",
   bbox_buffer = 1
)
...
make_demographics_table <- function(file_name,
  ...
  #   tab_header(
  #     title = table_title,
  #     subtitle = paste("Selected counties on", map_date)
  #   ) |>
  #   fmt_number(
  ...
  #   ) |>
  #   text_transform(
  #     locations = cells_body(columns = `Population Density Change`),
  ...
  #   )
  # 
  # # Save table as image/html if requested
  # if (!is.null(output_table_name)) {
  #   gtsave(
  #     demo_table,
  #     here("Outputs", output_table_name)
  #   )
  # }
